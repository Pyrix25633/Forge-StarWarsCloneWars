...
public class ModelLaserShot<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(
			new ResourceLocation("modid", "lasershot"), "main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition cube_r1 = bb_main.addOrReplaceChild("cube_r1",
				CubeListBuilder.create().texOffs(0, 0)
						.addBox(-21.0F, -1.0F, 0.0F, 14.0F, 2.0F, 0.0F, new CubeDeformation(0.0F)).texOffs(-2, 0)
						.addBox(-21.0F, 0.0F, -1.0F, 14.0F, 0.0F, 2.0F, new CubeDeformation(0.0F)),
