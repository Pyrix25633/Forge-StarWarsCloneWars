...
public class ModelSeparatistTank<T extends Entity> extends EntityModel<T> {
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition tank = partdefinition.addOrReplaceChild("tank",
				CubeListBuilder.create().texOffs(0, 202).addBox(-16.0F, -6.0F, -48.0F, 32.0F, 6.0F, 48.0F, new CubeDeformation(0.0F))
						.texOffs(112, 204).addBox(-24.0F, -6.0F, -40.0F, 8.0F, 6.0F, 40.0F, new CubeDeformation(0.0F)).texOffs(112, 204).mirror()
						.addBox(16.0F, -6.0F, -40.0F, 8.0F, 6.0F, 40.0F, new CubeDeformation(0.0F)).mirror(false).texOffs(168, 205)
						.addBox(-32.0F, -6.0F, -32.0F, 8.0F, 6.0F, 32.0F, new CubeDeformation(0.0F)).texOffs(168, 205).mirror()
						.addBox(24.0F, -6.0F, -32.0F, 8.0F, 6.0F, 32.0F, new CubeDeformation(0.0F)).mirror(false).texOffs(0, 168)
						...
						.addBox(16.0F, -14.0F, -7.0F, 6.0F, 8.0F, 12.0F, new CubeDeformation(0.0F)).mirror(false).texOffs(0, 230).mirror()
						.addBox(16.0F, -22.0F, -1.0F, 6.0F, 8.0F, 12.0F, new CubeDeformation(0.0F)).mirror(false).texOffs(0, 230).mirror()
