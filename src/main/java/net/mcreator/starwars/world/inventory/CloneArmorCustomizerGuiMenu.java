...
package net.mcreator.starwars.world.inventory;
...
import net.mcreator.starwars.init.StarWarsModMenus;

import java.util.function.Supplier;
import java.util.Map;
import java.util.HashMap;

public class CloneArmorCustomizerGuiMenu extends AbstractContainerMenu implements Supplier<Map<Integer, Slot>> {
	...
	public CloneArmorCustomizerGuiMenu(int id, Inventory inv, FriendlyByteBuf extraData) {
		super(StarWarsModMenus.CLONE_ARMOR_CUSTOMIZER_GUI, id);
