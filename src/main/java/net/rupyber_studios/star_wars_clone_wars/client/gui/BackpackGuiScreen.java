...
public class BackpackGuiScreen extends AbstractContainerScreen<BackpackGuiMenu> {
	...
	private static final ResourceLocation texture = new ResourceLocation("star_wars:textures/screens/backpack_gui.png");
	...
	protected void renderLabels(GuiGraphics guiGraphics, int mouseX, int mouseY) {
		guiGraphics.drawString(this.font, Component.translatable("gui.star_wars.backpack_gui.label_backpack"), 7, 5, -12829636, false);
	}
