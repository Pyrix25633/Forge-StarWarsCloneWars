...
public class SeparatistTankShotProjectileRenderer extends EntityRenderer<SeparatistTankShotProjectileEntity> {
	...
	public SeparatistTankShotProjectileRenderer(EntityRendererProvider.Context context) {
		super(context);
		model = new ModelLaserShot(context.bakeLayer(ModelLaserShot.LAYER_LOCATION));
	}

	@Override
	public void render(SeparatistTankShotProjectileEntity entityIn, float entityYaw, float partialTicks, PoseStack poseStack, MultiBufferSource bufferIn, int packedLightIn) {
	...
	@Override
	public ResourceLocation getTextureLocation(SeparatistTankShotProjectileEntity entity) {
		return texture;
	}
}
