...
public class BlasterDc15sProjectileRenderer extends EntityRenderer<BlasterDc15sProjectileEntity> {
	...
	public BlasterDc15sProjectileRenderer(EntityRendererProvider.Context context) {
		super(context);
		model = new ModelLaserShot(context.bakeLayer(ModelLaserShot.LAYER_LOCATION));
	}

	@Override
	public void render(BlasterDc15sProjectileEntity entityIn, float entityYaw, float partialTicks, PoseStack poseStack, MultiBufferSource bufferIn, int packedLightIn) {
	...
	@Override
	public ResourceLocation getTextureLocation(BlasterDc15sProjectileEntity entity) {
		return texture;
	}
}
