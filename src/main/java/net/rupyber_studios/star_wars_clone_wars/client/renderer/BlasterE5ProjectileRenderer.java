...
public class BlasterE5ProjectileRenderer extends EntityRenderer<BlasterE5ProjectileEntity> {
	...
	public BlasterE5ProjectileRenderer(EntityRendererProvider.Context context) {
		super(context);
		model = new ModelLaserShot(context.bakeLayer(ModelLaserShot.LAYER_LOCATION));
	}

	@Override
	public void render(BlasterE5ProjectileEntity entityIn, float entityYaw, float partialTicks, PoseStack poseStack, MultiBufferSource bufferIn, int packedLightIn) {
	...
	@Override
	public ResourceLocation getTextureLocation(BlasterE5ProjectileEntity entity) {
		return texture;
	}
}
