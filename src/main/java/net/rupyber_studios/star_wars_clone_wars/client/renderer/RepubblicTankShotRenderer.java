...
public class RepubblicTankShotRenderer extends EntityRenderer<RepubblicTankShotEntity> {
	...
	public RepubblicTankShotRenderer(EntityRendererProvider.Context context) {
		super(context);
		model = new ModelLaserShot(context.bakeLayer(ModelLaserShot.LAYER_LOCATION));
	}

	@Override
	public void render(RepubblicTankShotEntity entityIn, float entityYaw, float partialTicks, PoseStack poseStack, MultiBufferSource bufferIn, int packedLightIn) {
	...
	@Override
	public ResourceLocation getTextureLocation(RepubblicTankShotEntity entity) {
		return texture;
	}
}
