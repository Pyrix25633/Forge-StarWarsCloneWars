...
public class RepubblicTankShotProjectileRenderer extends EntityRenderer<RepubblicTankShotProjectileEntity> {
	...
	public RepubblicTankShotProjectileRenderer(EntityRendererProvider.Context context) {
		super(context);
		model = new ModelLaserShot(context.bakeLayer(ModelLaserShot.LAYER_LOCATION));
	}

	@Override
	public void render(RepubblicTankShotProjectileEntity entityIn, float entityYaw, float partialTicks, PoseStack poseStack, MultiBufferSource bufferIn, int packedLightIn) {
	...
	@Override
	public ResourceLocation getTextureLocation(RepubblicTankShotProjectileEntity entity) {
		return texture;
	}
}
