...
public class CloneTrooper41stEntity extends Monster implements RangedAttackMob {
	public CloneTrooper41stEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(StarWarsModEntities.CLONE_TROOPER_41ST.get(), world);
	}

	public CloneTrooper41stEntity(EntityType<CloneTrooper41stEntity> type, Level world) {
		super(type, world);
		xpReward = 0;
		setNoAi(false);
		...
		this.setItemSlot(EquipmentSlot.HEAD, new ItemStack(StarWarsModItems.CLONE_TROOPER_41ST_ARMOR_HELMET.get()));
		this.setItemSlot(EquipmentSlot.CHEST, new ItemStack(StarWarsModItems.CLONE_TROOPER_41ST_ARMOR_CHESTPLATE.get()));
		this.setItemSlot(EquipmentSlot.LEGS, new ItemStack(StarWarsModItems.CLONE_TROOPER_41ST_ARMOR_LEGGINGS.get()));
		this.setItemSlot(EquipmentSlot.FEET, new ItemStack(StarWarsModItems.CLONE_TROOPER_41ST_ARMOR_BOOTS.get()));
	}
