...
public class DroidCommanderKashyyykEntity extends Monster implements RangedAttackMob {
	public DroidCommanderKashyyykEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(StarWarsModEntities.DROID_COMMANDER_KASHYYYK.get(), world);
	}

	public DroidCommanderKashyyykEntity(EntityType<DroidCommanderKashyyykEntity> type, Level world) {
		super(type, world);
		xpReward = 4;
		setNoAi(false);
