...
public class CloneTrooperCommanderGreeEntity extends Monster implements RangedAttackMob {
	public CloneTrooperCommanderGreeEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(StarWarsModEntities.CLONE_TROOPER_COMMANDER_GREE.get(), world);
	}

	public CloneTrooperCommanderGreeEntity(EntityType<CloneTrooperCommanderGreeEntity> type, Level world) {
		super(type, world);
		setMaxUpStep(0.6f);
		xpReward = 0;
		setNoAi(false);
		...
		this.setItemSlot(EquipmentSlot.HEAD, new ItemStack(StarWarsModItems.CLONE_TROOPER_COMMANDER_GREE_ARMOR_HELMET.get()));
		this.setItemSlot(EquipmentSlot.CHEST, new ItemStack(StarWarsModItems.CLONE_TROOPER_COMMANDER_GREE_ARMOR_CHESTPLATE.get()));
		this.setItemSlot(EquipmentSlot.LEGS, new ItemStack(StarWarsModItems.CLONE_TROOPER_COMMANDER_GREE_ARMOR_LEGGINGS.get()));
		this.setItemSlot(EquipmentSlot.FEET, new ItemStack(StarWarsModItems.CLONE_TROOPER_COMMANDER_GREE_ARMOR_BOOTS.get()));
	}
