...
public class DroidPilotEntity extends Monster implements RangedAttackMob {
	public DroidPilotEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(StarWarsModEntities.DROID_PILOT.get(), world);
	}
