...
public class CloneTrooperCommanderWolffeEntity extends Monster implements RangedAttackMob {
	public CloneTrooperCommanderWolffeEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(StarWarsModEntities.CLONE_TROOPER_COMMANDER_WOLFFE.get(), world);
	}
	...
	public CloneTrooperCommanderWolffeEntity(EntityType<CloneTrooperCommanderWolffeEntity> type, Level world) {
		...
		xpReward = 0;
		setNoAi(false);
		setCustomName(new TextComponent("Commander Wolffe"));
		setCustomNameVisible(true);
		setPersistenceRequired();
		this.setItemSlot(EquipmentSlot.MAINHAND, new ItemStack(StarWarsModItems.BLASTER_DC_17.get()));
		this.setItemSlot(EquipmentSlot.OFFHAND, new ItemStack(StarWarsModItems.BLASTER_DC_17.get()));
		this.setItemSlot(EquipmentSlot.HEAD, new ItemStack(StarWarsModItems.CLONE_TROOPER_COMMANDER_WOLFFE_ARMOR_HELMET.get()));
		this.setItemSlot(EquipmentSlot.CHEST, new ItemStack(StarWarsModItems.CLONE_TROOPER_COMMANDER_WOLFFE_ARMOR_CHESTPLATE.get()));
		this.setItemSlot(EquipmentSlot.LEGS, new ItemStack(StarWarsModItems.CLONE_TROOPER_COMMANDER_WOLFFE_ARMOR_LEGGINGS.get()));
		this.setItemSlot(EquipmentSlot.FEET, new ItemStack(StarWarsModItems.CLONE_TROOPER_COMMANDER_WOLFFE_ARMOR_BOOTS.get()));
	}
