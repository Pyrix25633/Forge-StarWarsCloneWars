...
public class CloneTrooperSergeantEntity extends Monster implements RangedAttackMob {
	public CloneTrooperSergeantEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(StarWarsModEntities.CLONE_TROOPER_SERGEANT.get(), world);
	}

	public CloneTrooperSergeantEntity(EntityType<CloneTrooperSergeantEntity> type, Level world) {
		super(type, world);
		xpReward = 0;
		setNoAi(false);
		setCustomName(new TextComponent("Clone Sergeant"));
		setCustomNameVisible(true);
		setPersistenceRequired();
		this.setItemSlot(EquipmentSlot.MAINHAND, new ItemStack(StarWarsModItems.BLASTER_DC_15S.get()));
		this.setItemSlot(EquipmentSlot.HEAD, new ItemStack(StarWarsModItems.CLONE_TROOPER_SERGEANT_ARMOR_HELMET.get()));
		this.setItemSlot(EquipmentSlot.CHEST, new ItemStack(StarWarsModItems.CLONE_TROOPER_SERGEANT_ARMOR_CHESTPLATE.get()));
		this.setItemSlot(EquipmentSlot.LEGS, new ItemStack(StarWarsModItems.CLONE_TROOPER_SERGEANT_ARMOR_LEGGINGS.get()));
		this.setItemSlot(EquipmentSlot.FEET, new ItemStack(StarWarsModItems.CLONE_TROOPER_SERGEANT_ARMOR_BOOTS.get()));
	}
