...
public class BlasterDc15sEntity extends AbstractArrow implements ItemSupplier {
	public BlasterDc15sEntity(PlayMessages.SpawnEntity packet, Level world) {
		super(StarWarsModEntities.BLASTER_DC_15S.get(), world);
	}

	public BlasterDc15sEntity(EntityType<? extends BlasterDc15sEntity> type, Level world) {
		super(type, world);
	}

	public BlasterDc15sEntity(EntityType<? extends BlasterDc15sEntity> type, double x, double y, double z, Level world) {
		super(type, x, y, z, world);
	}

	public BlasterDc15sEntity(EntityType<? extends BlasterDc15sEntity> type, LivingEntity entity, Level world) {
	...
	public static BlasterDc15sEntity shoot(Level world, LivingEntity entity, RandomSource random, float power, double damage, int knockback) {
		BlasterDc15sEntity entityarrow = new BlasterDc15sEntity(StarWarsModEntities.BLASTER_DC_15S.get(), entity, world);
