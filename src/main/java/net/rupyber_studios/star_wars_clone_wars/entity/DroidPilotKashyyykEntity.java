...
public class DroidPilotKashyyykEntity extends Monster implements RangedAttackMob {
	public DroidPilotKashyyykEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(StarWarsModEntities.DROID_PILOT_KASHYYYK.get(), world);
	}

	public DroidPilotKashyyykEntity(EntityType<DroidPilotKashyyykEntity> type, Level world) {
		super(type, world);
		xpReward = 4;
		setNoAi(false);
