...
public class CloneTrooperCaptainRexEntity extends Monster implements RangedAttackMob {
	public CloneTrooperCaptainRexEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(StarWarsModEntities.CLONE_TROOPER_CAPTAIN_REX.get(), world);
	}
	...
	public CloneTrooperCaptainRexEntity(EntityType<CloneTrooperCaptainRexEntity> type, Level world) {
		...
		xpReward = 0;
		setNoAi(false);
		setCustomName(new TextComponent("Captain Rex"));
		...
		this.setItemSlot(EquipmentSlot.HEAD, new ItemStack(StarWarsModItems.CLONE_TROOPER_CAPTAIN_REX_ARMOR_HELMET.get()));
		this.setItemSlot(EquipmentSlot.CHEST, new ItemStack(StarWarsModItems.CLONE_TROOPER_CAPTAIN_REX_ARMOR_CHESTPLATE.get()));
		this.setItemSlot(EquipmentSlot.LEGS, new ItemStack(StarWarsModItems.CLONE_TROOPER_CAPTAIN_REX_ARMOR_LEGGINGS.get()));
		this.setItemSlot(EquipmentSlot.FEET, new ItemStack(StarWarsModItems.CLONE_TROOPER_CAPTAIN_REX_ARMOR_BOOTS.get()));
	}
