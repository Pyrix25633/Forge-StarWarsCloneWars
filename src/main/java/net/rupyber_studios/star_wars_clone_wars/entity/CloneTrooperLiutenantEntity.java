...
public class CloneTrooperLiutenantEntity extends Monster implements RangedAttackMob {
	public CloneTrooperLiutenantEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(StarWarsModEntities.CLONE_TROOPER_LIUTENANT.get(), world);
	}
	...
	public CloneTrooperLiutenantEntity(EntityType<CloneTrooperLiutenantEntity> type, Level world) {
		...
		this.setItemSlot(EquipmentSlot.HEAD, new ItemStack(StarWarsModItems.CLONE_TROOPER_LIUTENANT_ARMOR_HELMET.get()));
		this.setItemSlot(EquipmentSlot.CHEST, new ItemStack(StarWarsModItems.CLONE_TROOPER_LIUTENANT_ARMOR_CHESTPLATE.get()));
		this.setItemSlot(EquipmentSlot.LEGS, new ItemStack(StarWarsModItems.CLONE_TROOPER_LIUTENANT_ARMOR_LEGGINGS.get()));
		this.setItemSlot(EquipmentSlot.FEET, new ItemStack(StarWarsModItems.CLONE_TROOPER_LIUTENANT_ARMOR_BOOTS.get()));
	}
