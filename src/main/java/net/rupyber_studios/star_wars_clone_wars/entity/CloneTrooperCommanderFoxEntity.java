...
public class CloneTrooperCommanderFoxEntity extends Monster implements RangedAttackMob {
	public CloneTrooperCommanderFoxEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(StarWarsModEntities.CLONE_TROOPER_COMMANDER_FOX.get(), world);
	}

	public CloneTrooperCommanderFoxEntity(EntityType<CloneTrooperCommanderFoxEntity> type, Level world) {
		super(type, world);
		xpReward = 0;
		setNoAi(false);
		...
		this.setItemSlot(EquipmentSlot.HEAD, new ItemStack(StarWarsModItems.CLONE_TROOPER_COMMANDER_FOX_ARMOR_HELMET.get()));
		this.setItemSlot(EquipmentSlot.CHEST, new ItemStack(StarWarsModItems.CLONE_TROOPER_COMMANDER_FOX_ARMOR_CHESTPLATE.get()));
		this.setItemSlot(EquipmentSlot.LEGS, new ItemStack(StarWarsModItems.CLONE_TROOPER_COMMANDER_FOX_ARMOR_LEGGINGS.get()));
		this.setItemSlot(EquipmentSlot.FEET, new ItemStack(StarWarsModItems.CLONE_TROOPER_COMMANDER_FOX_ARMOR_BOOTS.get()));
	}
	...
	protected void registerGoals() {
		super.registerGoals();
		this.targetSelector.addGoal(1, new NearestAttackableTargetGoal(this, CloneTrooperEntity.class, false, false));
