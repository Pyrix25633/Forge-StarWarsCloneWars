...
public class CloneTrooperCommanderPondsEntity extends Monster implements RangedAttackMob {
	public CloneTrooperCommanderPondsEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(StarWarsModEntities.CLONE_TROOPER_COMMANDER_PONDS.get(), world);
	}
	...
	public CloneTrooperCommanderPondsEntity(EntityType<CloneTrooperCommanderPondsEntity> type, Level world) {
		...
		this.setItemSlot(EquipmentSlot.HEAD, new ItemStack(StarWarsModItems.CLONE_TROOPER_COMMANDER_PONDS_ARMOR_HELMET.get()));
		this.setItemSlot(EquipmentSlot.CHEST, new ItemStack(StarWarsModItems.CLONE_TROOPER_COMMANDER_PONDS_ARMOR_CHESTPLATE.get()));
		this.setItemSlot(EquipmentSlot.LEGS, new ItemStack(StarWarsModItems.CLONE_TROOPER_COMMANDER_PONDS_ARMOR_LEGGINGS.get()));
		this.setItemSlot(EquipmentSlot.FEET, new ItemStack(StarWarsModItems.CLONE_TROOPER_COMMANDER_PONDS_ARMOR_BOOTS.get()));
	}
	...
	protected void registerGoals() {
		...
		this.targetSelector.addGoal(9, new NearestAttackableTargetGoal(this, CloneTrooperEntity.class, false, false));
