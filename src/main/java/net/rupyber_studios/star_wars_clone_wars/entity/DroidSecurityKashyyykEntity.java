...
public class DroidSecurityKashyyykEntity extends Monster implements RangedAttackMob {
	public DroidSecurityKashyyykEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(StarWarsModEntities.DROID_SECURITY_KASHYYYK.get(), world);
	}

	public DroidSecurityKashyyykEntity(EntityType<DroidSecurityKashyyykEntity> type, Level world) {
		super(type, world);
		setMaxUpStep(0.6f);
		xpReward = 4;
		setNoAi(false);
