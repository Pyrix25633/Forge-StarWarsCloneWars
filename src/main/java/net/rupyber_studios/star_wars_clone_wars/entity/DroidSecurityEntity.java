...
public class DroidSecurityEntity extends Monster implements RangedAttackMob {
	public DroidSecurityEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(StarWarsModEntities.DROID_SECURITY.get(), world);
	}

	public DroidSecurityEntity(EntityType<DroidSecurityEntity> type, Level world) {
		super(type, world);
		setMaxUpStep(0.6f);
		xpReward = 4;
		setNoAi(false);
