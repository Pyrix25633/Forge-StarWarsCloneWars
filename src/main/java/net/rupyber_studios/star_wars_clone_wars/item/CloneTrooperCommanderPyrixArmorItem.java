...
public abstract class CloneTrooperCommanderPyrixArmorItem extends ArmorItem {
	public CloneTrooperCommanderPyrixArmorItem(ArmorItem.Type type, Item.Properties properties) {
		super(new ArmorMaterial() {
			...
			public String getName() {
				return "clone_trooper_commander_pyrix_armor";
			}
	...
	public static class Helmet extends CloneTrooperCommanderPyrixArmorItem {
		public Helmet() {
			...
			consumer.accept(new IClientItemExtensions() {
				...
				public HumanoidModel getHumanoidArmorModel(LivingEntity living, ItemStack stack, EquipmentSlot slot, HumanoidModel defaultModel) {
					HumanoidModel armorModel = new HumanoidModel(new ModelPart(Collections.emptyList(),
							Map.of("head", new ModelHelmetMacros(Minecraft.getInstance().getEntityModels().bakeLayer(ModelHelmetMacros.LAYER_LOCATION)).head, "hat", new ModelPart(Collections.emptyList(), Collections.emptyMap()), "body",
		...
		public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlot slot, String type) {
			return "star_wars:textures/entities/clone_armor_armor_pyrix_layer_helmet.png";
		}
	}

	public static class Chestplate extends CloneTrooperCommanderPyrixArmorItem {
		public Chestplate() {
		...
		@Override
		public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlot slot, String type) {
			return "star_wars:textures/entities/clone_armor_armor_pyrix_layer_chestplate.png";
		}
	}

	public static class Leggings extends CloneTrooperCommanderPyrixArmorItem {
		public Leggings() {
		...
		@Override
		public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlot slot, String type) {
			return "star_wars:textures/entities/clone_armor_armor_pyrix_layer_leggings.png";
		}
	}

	public static class Boots extends CloneTrooperCommanderPyrixArmorItem {
		public Boots() {
		...
		@Override
		public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlot slot, String type) {
			return "star_wars:textures/models/armor/clone_armor_armor_pyrix_layer_1.png";
		}
	}
}
