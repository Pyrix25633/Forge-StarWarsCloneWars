...
public abstract class CloneTrooperCaptainRexArmorItem extends ArmorItem {
	public CloneTrooperCaptainRexArmorItem(ArmorItem.Type type, Item.Properties properties) {
		super(new ArmorMaterial() {
			...
			public String getName() {
				return "clone_trooper_captain_rex_armor";
			}
	...
	public static class Helmet extends CloneTrooperCaptainRexArmorItem {
		public Helmet() {
	...
	public static class Chestplate extends CloneTrooperCaptainRexArmorItem {
		...
		@Override
		public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlot slot, String type) {
			return "star_wars:textures/entities/clone_armor_armor_rex_layer_chestplate.png";
		}
	}

	public static class Leggings extends CloneTrooperCaptainRexArmorItem {
		public Leggings() {
		...
		@Override
		public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlot slot, String type) {
			return "star_wars:textures/entities/clone_armor_armor_rex_layer_leggings.png";
		}
	}

	public static class Boots extends CloneTrooperCaptainRexArmorItem {
		public Boots() {
