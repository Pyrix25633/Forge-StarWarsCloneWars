...
public abstract class CloneTrooperCommanderFoxArmorItem extends ArmorItem {
	public CloneTrooperCommanderFoxArmorItem(EquipmentSlot slot, Item.Properties properties) {
			...
			consumer.accept(new IClientItemExtensions() {
				...
				public HumanoidModel getHumanoidArmorModel(LivingEntity living, ItemStack stack, EquipmentSlot slot, HumanoidModel defaultModel) {
					HumanoidModel armorModel = new HumanoidModel(new ModelPart(Collections.emptyList(), Map.of("head",
							new ModelHelmetSunvisor(Minecraft.getInstance().getEntityModels().bakeLayer(ModelHelmetSunvisor.LAYER_LOCATION)).head,
