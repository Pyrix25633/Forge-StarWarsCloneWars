...
public class MusicDiskRepublicItem extends RecordItem {
	public MusicDiskRepublicItem() {
		super(0, () -> ForgeRegistries.SOUND_EVENTS.getValue(new ResourceLocation("star_wars:record.republic")),
				new Item.Properties().tab(StarWarsModTabs.TAB_REPUBLIC).stacksTo(1).rarity(Rarity.RARE), 0);
	}
}
