...
public class StarWarsModBlocks {
	...
	public static final RegistryObject<Block> CLONE_ARMOR_CUSTOMIZER = REGISTRY.register("clone_armor_customizer", () -> new CloneArmorCustomizerBlock());
	...
	public static final RegistryObject<Block> GEONOSIS_DIMENSION_PORTAL = REGISTRY.register("geonosis_dimension_portal", () -> new GeonosisDimensionPortalBlock());
	public static final RegistryObject<Block> KASHYYYK_DIMENSION_PORTAL = REGISTRY.register("kashyyyk_dimension_portal", () -> new KashyyykDimensionPortalBlock());
	public static final RegistryObject<Block> FELUCIA_DIMENSION_PORTAL = REGISTRY.register("felucia_dimension_portal", () -> new FeluciaDimensionPortalBlock());
	...
	public static final RegistryObject<Block> FELUCIA_BLUE_FENCE_GATE = REGISTRY.register("felucia_blue_fence_gate", () -> new FeluciaBlueFenceGateBlock());
	public static final RegistryObject<Block> FELUCIA_BLUE_PRESSURE_PLATE = REGISTRY.register("felucia_blue_pressure_plate", () -> new FeluciaBluePressurePlateBlock());
	...
	public static final RegistryObject<Block> FELUCIA_RED_FENCE_GATE = REGISTRY.register("felucia_red_fence_gate", () -> new FeluciaRedFenceGateBlock());
	public static final RegistryObject<Block> FELUCIA_RED_PRESSURE_PLATE = REGISTRY.register("felucia_red_pressure_plate", () -> new FeluciaRedPressurePlateBlock());
	...
	public static final RegistryObject<Block> FELUCIA_YELLOW_PLANKS = REGISTRY.register("felucia_yellow_planks", () -> new FeluciaYellowPlanksBlock());
	public static final RegistryObject<Block> FELUCIA_YELLOW_LEAVES = REGISTRY.register("felucia_yellow_leaves", () -> new FeluciaYellowLeavesBlock());
	public static final RegistryObject<Block> FELUCIA_YELLOW_STAIRS = REGISTRY.register("felucia_yellow_stairs", () -> new FeluciaYellowStairsBlock());
	...
	public static final RegistryObject<Block> FELUCIA_YELLOW_FENCE_GATE = REGISTRY.register("felucia_yellow_fence_gate", () -> new FeluciaYellowFenceGateBlock());
	public static final RegistryObject<Block> FELUCIA_YELLOW_PRESSURE_PLATE = REGISTRY.register("felucia_yellow_pressure_plate", () -> new FeluciaYellowPressurePlateBlock());
	public static final RegistryObject<Block> FELUCIA_YELLOW_BUTTON = REGISTRY.register("felucia_yellow_button", () -> new FeluciaYellowButtonBlock());
