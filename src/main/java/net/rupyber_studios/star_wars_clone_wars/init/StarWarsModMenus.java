...
public class StarWarsModMenus {
	...
	public static final RegistryObject<MenuType<CloneArmorCustomizerGuiMenu>> CLONE_ARMOR_CUSTOMIZER_GUI = REGISTRY.register("clone_armor_customizer_gui", () -> IForgeMenuType.create(CloneArmorCustomizerGuiMenu::new));
	public static final RegistryObject<MenuType<RepubblicTankGuiMenu>> REPUBBLIC_TANK_GUI = REGISTRY.register("repubblic_tank_gui", () -> IForgeMenuType.create(RepubblicTankGuiMenu::new));
