...
public class KashyyykMountainsLeaveDecorator extends LeaveVineDecorator {
	public static final KashyyykMountainsLeaveDecorator INSTANCE = new KashyyykMountainsLeaveDecorator();
	public static com.mojang.serialization.Codec<LeaveVineDecorator> codec;
	public static TreeDecoratorType<?> tdt;
	static {
		codec = com.mojang.serialization.Codec.unit(() -> INSTANCE);
		tdt = new TreeDecoratorType<>(codec);
		ForgeRegistries.TREE_DECORATOR_TYPES.register("kashyyyk_mountains_tree_leave_decorator", tdt);
	}
