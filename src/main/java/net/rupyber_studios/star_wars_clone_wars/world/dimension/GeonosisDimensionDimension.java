...
package net.rupyber_studios.star_wars_clone_wars.world.dimension;
...
public class GeonosisDimensionDimension {
	...
	public static class Fixers {
		...
		public static void registerDimensionSpecialEffects(FMLClientSetupEvent event) {
			...
			event.enqueueWork(() -> DimensionSpecialEffects.EFFECTS.put(new ResourceLocation("star_wars:geonosis_dimension"), customEffect));
		}
	}
}
