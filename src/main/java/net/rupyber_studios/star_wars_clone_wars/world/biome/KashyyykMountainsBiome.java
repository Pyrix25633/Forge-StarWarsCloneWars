...
import net.rupyber_studios.star_wars_clone_wars.world.features.treedecorators.KashyyykMountainsTrunkDecorator;
import net.rupyber_studios.star_wars_clone_wars.world.features.treedecorators.KashyyykMountainsLeaveDecorator;
...
public class KashyyykMountainsBiome {
	public static Biome createBiome() {
		...
		biomeGenerationSettings.addFeature(GenerationStep.Decoration.VEGETAL_DECORATION,
				PlacementUtils.register("star_wars:tree_kashyyyk_mountains", FeatureUtils.register("star_wars:tree_kashyyyk_mountains", Feature.TREE,
						new TreeConfiguration.TreeConfigurationBuilder(BlockStateProvider.simple(Blocks.JUNGLE_LOG.defaultBlockState()),
								...
								.decorators(ImmutableList.of(KashyyykMountainsLeaveDecorator.INSTANCE, KashyyykMountainsTrunkDecorator.INSTANCE))
								.build()),
						List.of(CountPlacement.of(5), InSquarePlacement.spread(), SurfaceWaterDepthFilter.forMaxDepth(0),
								PlacementUtils.HEIGHTMAP_OCEAN_FLOOR, PlacementUtils.filteredByBlockSurvival(Blocks.OAK_SAPLING),
								BiomeFilter.biome())));
		biomeGenerationSettings.addFeature(GenerationStep.Decoration.VEGETAL_DECORATION,
				PlacementUtils.register("star_wars:grass_kashyyyk_mountains", VegetationFeatures.PATCH_GRASS,
						List.of(NoiseThresholdCountPlacement.of(-0.8D, 5, 4), InSquarePlacement.spread(), PlacementUtils.HEIGHTMAP_WORLD_SURFACE,
								BiomeFilter.biome())));
		biomeGenerationSettings.addFeature(GenerationStep.Decoration.VEGETAL_DECORATION,
				PlacementUtils.register("star_wars:flower_kashyyyk_mountains", VegetationFeatures.FLOWER_DEFAULT, List.of(CountPlacement.of(3),
						RarityFilter.onAverageOnceEvery(32), InSquarePlacement.spread(), PlacementUtils.HEIGHTMAP, BiomeFilter.biome())));
		biomeGenerationSettings.addFeature(GenerationStep.Decoration.VEGETAL_DECORATION,
				PlacementUtils.register("star_wars:disk_sand_kashyyyk_mountains",
						FeatureUtils.register("star_wars:disk_sand_kashyyyk_mountains", Feature.DISK,
